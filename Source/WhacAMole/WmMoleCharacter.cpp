...
void AWmMoleCharacter::BeginPlay()
{
	...
	//APlayerController* PlayerController = UGameplayStatics::CreatePlayer(this, -1, false);
...
void AWmMoleCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		//Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AWmMoleCharacter::Move);
...
void AWmMoleCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
/*void AWmMoleCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
